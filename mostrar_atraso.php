...
<html>
    <head><meta http-equiv="Content-Type" content="text/html; charset=gb18030"> 
        ...
        <link rel="stylesheet" type="text/css" href="css/CSSatraso.css">
        <script src="js/JSatraso.js"></script>
    </head>
    <body>
        <header>
           <?php
           ...
           <form  action="mostrar_atraso.php" method="post" >
...
$sql ="SELECT idAlumno,dia,mes,idCurso FROM atraso_2019  WHERE idCurso ='".$_POST['select_curso']."' and mes=".$mes.";";
$result = $conexion->query($sql);
