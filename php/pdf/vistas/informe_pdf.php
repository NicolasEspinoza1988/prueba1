...
$sql ="SELECT  idAlumno,nombre,apellido1,apellido2,idCurso FROM alumno_2022 WHERE  idAlumno = ".$idalumno.";";
...
echo "<tr style='border:1' ><td style='text-align:center;margin-left:7px;border:1' >Asignatura</td><td style='border:1' >N1</td><td style='border:1' >N2</td><td style='border:1' >N3</td><td style='border:1' >N4</td><td style='border:1' >N5</td><td style='border:1'>N6</td><td style='border:1'>N7</td><td style='border:1'>N8</td><td style='border:1' >N9</td><td style='border:1' >N10</td><td style='border:1'>PROM</td></tr>";
 ...
 $sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM lenguaje_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM matematica_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM ciencias_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM tecnologia_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM musica_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM fisica_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM historia_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM artes_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM ingles_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  n1, n2 , n3 , n4 , n5 , n6 , n7 , n8 , n9 , n10 , prom FROM religion_2022_p1 WHERE idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
$sql ="SELECT  idAlumno FROM asistencia_2022 WHERE  idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
if ($result->num_rows > 0) { $dias_inasistencia=$result->num_rows;}

$sql ="SELECT  idAlumno FROM atraso_2022 WHERE  idAlumno = ".$idalumno.";";
$result = $conexion->query($sql);
...
echo "<br><br><br><br><br><p class='txt_fecha'>".utf8_encode(strftime("%A  %d de %B  del  %Y"))."</p></body></html>";
?>
