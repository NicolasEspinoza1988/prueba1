<?php
    session_start();
    $_SESSION['idalumno'] = $_POST['alumno_select'];
   ...
   // include(dirname(__FILE__).'/vistas/pdf_blanco.php');
    $ruta=($_SESSION['semestre_select'] === 'S1' ? '/vistas/informe_pdf.php' : '/vistas/informe_s2_pdf.php');
    include(dirname(__FILE__).$ruta);
    //include(dirname(__FILE__).'/vistas/informe_pdf.php');
