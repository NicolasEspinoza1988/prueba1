    ...
    <body id='informe_sec '>
        ...
        <main >
            ...
            <div class="contenedor" id="sn_informe_cont">
                ...
                <form id="forminforme" action="php/pdf/pdf_blanco.php" method="post" >
                ...
                <p class='informe' >Seleccione el alumno: </p>
                <select id="alumno_select" name='alumno_select' onchange="" required >
        ...
        <footer>
            <div class="contenedor">
                <p class="copy">Colegio Saint Germaine La Florida 2019 &copy;</p>
                <div class="sociales">
