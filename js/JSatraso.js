...
if( element.checked == true){
	...
	var url="http://www.sgsintranet.cl/registro_atraso.php?idalumno="+ tid + "&dia=" +tdia+"&mes="+tmes+"&curso="+tcurso;
	 //alert(url);
...
else
{
	...
	//alert(tid + " dia=" + tdia + " mes="+ tmes + " curso="+ tcurso);
	var xhttp = new XMLHttpRequest();
	var url="http://www.sgsintranet.cl/borrar_atraso.php?idalumno="+ tid + "&dia=" +tdia+"&mes="+tmes+"&curso="+tcurso;
	 //alert(url);
	xhttp.open("GET", url, true);
	xhttp.send();
